...
//DBG_PRINT("wwj: R_IOH_BUFFER == 0x%x\r\n", R_IOH_BUFFER);
  ...
  //#endif
	...
	#if 0
	gpio_init_io(M_LED_0, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_0, ATTRIBUTE_HIGH);
  	gpio_write_io(M_LED_0, DATA_HIGH);

	gpio_init_io(M_LED_1, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_1, ATTRIBUTE_HIGH);
  	gpio_write_io(M_LED_1, DATA_HIGH);

	gpio_init_io(M_LED_2, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_2, ATTRIBUTE_HIGH);
  	gpio_write_io(M_LED_2, DATA_HIGH);

	gpio_init_io(M_LED_3, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_3, ATTRIBUTE_HIGH);
  	gpio_write_io(M_LED_3, DATA_HIGH);

	gpio_init_io(M_LED_4, GPIO_OUTPUT);
  	gpio_set_port_attribute(M_LED_4, ATTRIBUTE_HIGH);
